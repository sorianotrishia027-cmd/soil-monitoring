...
// Track active view tab component context
$page = $_GET['page'] ?? 'home';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Magssaka Rice Farmers Cooperative</title>
    ...
    <div class="dashboard-layout-wrapper">
        <nav class="sidebar-nav-panel">
            <div class="sidebar-brand-header">
                <div class="circular-logo-icon">🌾</div>
            </div>
            ...
            <ul class="sidebar-menu-links">
                ...
                <li>
                    <a href="dashboard.php?page=soil" class="menu-link-item <?php echo $page === 'soil' ? 'active' : ''; ?>">
                        <span class="nav-icon">📊</span> <span class="nav-text">Soil Data</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="dashboard.php?page=recommendations" class="menu-link-item <?php echo $page === 'recommendations' ? 'active' : ''; ?>">
                        <span class="nav-icon">📍</span> <span class="nav-text">Recommendations</span>
                    </a>
                </li>
            </ul>
